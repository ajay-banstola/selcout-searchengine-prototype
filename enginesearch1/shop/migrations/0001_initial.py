    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.PositiveIntegerField(blank=True, default=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='products/%Y/%m/%d')),
                ('number', models.ForeignKey(default=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='shop.Category')),
            ],
            options={
                'ordering': ('name',),
            },
